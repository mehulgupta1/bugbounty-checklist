  ...
  return (
    <aside className="sidebar" aria-label="Navigation">
      ...
      <div className="sidebar-actions">
        ...
        <button
          className={`sidebar-action-btn ${currentView === "scope" ? "sidebar-action-btn--active" : ""}`}
          onClick={() => onSetView(currentView === "scope" ? "checklist" : "scope")}
        >
          <span className="sidebar-action-icon">🎯</span>
          Target Scope
        </button>
        <button
          className={`sidebar-action-btn ${currentView === "intel" ? "sidebar-action-btn--active" : ""}`}
          onClick={() => onSetView(currentView === "intel" ? "checklist" : "intel")}
        >
          <span className="sidebar-action-icon">🌍</span>
          Scope Intel
        </button>
        ...
        <button
          className={`sidebar-action-btn ${currentView === "programs" ? "sidebar-action-btn--active" : ""}`}
          onClick={() => onSetView(currentView === "programs" ? "checklist" : "programs")}
        >
          <span className="sidebar-action-icon">🤝</span>
          Programs
        </button>
        ...
        <button
          className={`sidebar-action-btn ${currentView === "methodology" ? "sidebar-action-btn--active" : ""}`}
          onClick={() => onSetView(currentView === "methodology" ? "checklist" : "methodology")}
        >
          <span className="sidebar-action-icon">📋</span>
          Asset Board
        </button>
        <button
          className={`sidebar-action-btn ${currentView === "testflows" ? "sidebar-action-btn--active" : ""}`}
          onClick={() => onSetView(currentView === "testflows" ? "checklist" : "testflows")}
        >
          <span className="sidebar-action-icon">🌊</span>
          Test Flows
        </button>
